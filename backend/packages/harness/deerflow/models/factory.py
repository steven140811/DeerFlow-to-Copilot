...
def create_chat_model(name: str | None = None, thinking_enabled: bool = False, *, app_config: AppConfig | None = None, attach_tracing: bool = True, **kwargs) -> BaseChatModel:
    ...
    explicit_reasoning_effort = kwargs.pop("reasoning_effort", None)
    ...
    if issubclass(model_class, CodexChatModel):
        ...
        elif explicit_reasoning_effort and explicit_reasoning_effort in ("low", "medium", "high", "xhigh"):
            model_settings_from_config["reasoning_effort"] = explicit_reasoning_effort
