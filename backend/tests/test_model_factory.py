...
def test_runtime_reasoning_effort_overrides_config_without_duplicate_kwargs(monkeypatch):
    model = ModelConfig(
        name="vscode-copilot",
    ...
    factory_module.create_chat_model(name="vscode-copilot", reasoning_effort="xhigh")
