...
export function InputBox({
  ...
  useEffect(() => {
    ...
    onContextChange?.({
      ...
      model_supports_thinking: supportsThinking,
      mode: nextMode,
    });
  ...
  const handleModelSelect = useCallback(
    (model_name: string) => {
      ...
      onContextChange?.({
        ...context,
        model_name,
        model_supports_thinking: model.supports_thinking ?? false,
    ...
    (message: PromptInputMessage) => {
      ...
      if (resolvedModelName && context.model_name !== resolvedModelName) {
        onContextChange?.({
          ...
          model_supports_thinking: selectedModel?.supports_thinking ?? false,
